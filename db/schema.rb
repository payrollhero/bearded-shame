...
ActiveRecord::Schema.define(version: 20150427041837) do
  ...
  create_table "user_favorite_massages", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "massage_type_id"
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
  ...
  add_index "user_favorite_massages", ["massage_type_id"], name: "index_user_favorite_massages_on_massage_type_id"
